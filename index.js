import{a as P,R as C,C as N,S,N as M,P as E,A as H,b as h,K as D}from"./assets/vendor-p5_NXU9y.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();function R(e){const t=document.querySelector(".categories-desktop");if(!t)return;const s=[{_id:"all",name:"Всі десерти"},...e].map(({_id:r,name:o},a)=>`
      <label>
        <input
          type="radio"
          name="category"
    ...
    `).join("");t.innerHTML=s}const j=new URL("/Choco_bytes/assets/icons-qp2qQD9b.svg",import.meta.url).href;function U(e,t=!1){const n=document.querySelector(".desserts-list"),s=e.map(({_id:r,image:o,category:a,name:c,description:l,price:v})=>`
